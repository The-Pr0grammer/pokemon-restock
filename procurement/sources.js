const SOURCES = {
  ...
  bestbuy: {
    ...
    first_party_required: true,
    official_seller_names: ['Best Buy'],
    preserve_local_inventory: true,
  ...
  gamestop: {
    ...
    access: { mode: 'public_structured_surface', required_env: [] },
    first_party_required: true,
    official_seller_names: ['GameStop'],
    preserve_local_inventory: true,
  ...
  walmart: {
    ...
    access: { mode: 'public_structured_surface', required_env: [] },
    first_party_required: true,
    official_seller_names: ['Walmart.com', 'Walmart'],
    preserve_local_inventory: true,
  ...
  pokemoncenter: {
    ...
    first_party_required: true,
    official_seller_names: ['Pokemon Center', 'Pokémon Center'],
  ...
  barnesandnoble: {
    ...
    first_party_required: true,
    official_seller_names: ['Barnes & Noble', 'Barnes and Noble'],
    preserve_local_inventory: true,
  ...
  amazon: {
    ...
    first_party_required: true,
    official_seller_names: ['Amazon.com', 'Amazon'],
    preserve_local_inventory: false,
  ...
  samsclub: {
    ...
    access: { mode: 'public_structured_surface', required_env: [] },
    first_party_required: true,
    official_seller_names: ["Sam's Club", 'Sams Club'],
    preserve_local_inventory: true,
    notes: 'Club-store source. Bundle/unit economics and membership gating must be preserved.',
  },
};
